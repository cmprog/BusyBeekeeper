...
{
    internal sealed class ShopQueenSelectionItemComponent : ScreenComponent
    {
        ...
        public event Action<ShopQueenSelectionItemComponent> Click;
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.Draw(this.IconTexture, this.mIconPosition, null, Color.White, 0, Vector2.Zero, this.mIconSize, SpriteEffects.None, 0);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!this.mAreCalculationsValid)
            {
                ...
                this.mDescriptionTextPosition = new Vector2(
                    ...
                    this.mNameTextPosition.Y + lNameTextSize.Y + sItemMargin);
                ...
                this.mPriceTextPosition = new Vector2(
                    ...
                    this.mDescriptionTextPosition.Y + lDescriptionTextSize.Y + sItemMargin);
